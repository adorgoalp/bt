...
<!--
        ...
        ================================================== -->
<header id="top-bar" class="navbar-fixed-top animated-header"  style="background: #ffffff;">
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="navbar-brand" style="margin: 0;padding: 0;">
                <a href="#" >
                    <img style="width: 50%;" src="timeMaster/images/logo-png.png" alt="" >
                </a>
            </div>
            <!-- /logo -->
        </div>
        <!-- main menu -->
        <nav class="collapse navbar-collapse navbar-right" role="navigation" style="margin-top: 3%;">
            <div class="main-menu">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <!--<li class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <ul>
                                <li><a href="javascript:getPgName('controller=pages&action=blog_post')">post</a></li>
                                <li><a href="blog-left-sidebar">Blog Left sidebar</a></li>
                                <li><a href="blog-right-sidebar">Blog Right sidebar</a></li>
                            </ul>
                        </div>
                    </li>-->
                    <li><a href="?controller=pages&action=contact&type=master">Contact</a></li>
