            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-delay=".3s" >
                        <img src="timeMaster/images/about/about-company.jpg" alt="" class="img-responsive">
                    </div>
                    <div class="col-md-6">
                        <div class="block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".3s">
                            <div class="team-img">
                                <img src="timeMaster/images/team/team-1.jpg" class="team-pic" alt="">
                            </div>
                            <h3 class="team_name">Md. Mominul Islam</h3>
							<p class="team_designation">Msc in CSE, FERGUSAN INDIA</p>
                    ...
                    <div class="col-md-3">
                        <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".5s">
                            <div class="team-img">
                                <img src="timeMaster/images/team/team-2.jpg" class="team-pic" alt="">
                            </div>
                            <h3 class="team_name">Md.Imtiaz</h3>
							<p class="team_designation">Business administration, DHAKA UNIVERSITY</p>
                            <p class="team_designation">CEO, Business development, Planning and Marketing</p>
                            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore .</p>
                            <p class="social-icons">
                                <a href="#" class="facebook" target="_blank"><i class="ion-social-facebook-outline"></i></a>
                                <a href="#" target="_blank"><i class="ion-social-twitter-outline"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".7s">
                            <div class="team-img">
                                <img src="timeMaster/images/team/team-3.jpg" class="team-pic" alt="">
                            </div>
                            <h3 class="team_name">Engr. Md. Ifty</h3>
							<p class="team_designation">Bsc in CSE, BUET</p>
                            <p class="team_designation">CEO, Mobile Appication Developer</p>
                            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore .</p>
                            <p class="social-icons">
                                <a href="#" class="facebook" target="_blank"><i class="ion-social-facebook-outline"></i></a>
                                <a href="#" target="_blank"><i class="ion-social-twitter-outline"></i></a>
                    ...
                    <div class="col-md-3">
                        <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".9s">
                            <div class="team-img">
                                <img src="timeMaster/images/team/team-4.jpg" class="team-pic" alt="">
                            </div>
                            <h3 class="team_name">Md. Masudur Rahman</h3>
                            <p class="team_designation">CFO, Company Affairs and Admin</p>
                            <p class="team_text">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore .</p>
                            <p class="social-icons">
                                <a href="#" class="facebook" target="_blank"><i class="ion-social-facebook-outline"></i></a>
                                <a href="#" target="_blank"><i class="ion-social-twitter-outline"></i></a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="clients-logo" class="owl-carousel">
                            <div>
                                <img src="timeMaster/images/clients/logo-1.jpg" alt="">
                            </div>
                            <div>
                                <img src="timeMaster/images/clients/logo-2.jpg" alt="">
                            </div>
                            <div>
                                <img src="timeMaster/images/clients/logo-3.jpg" alt="">
                            </div>
                            <div>
                                <img src="timeMaster/images/clients/logo-4.jpg" alt="">
                            </div>
                            <div>
                                <img src="timeMaster/images/clients/logo-5.jpg" alt="">
                            </div>
                            <div>
                                <img src="timeMaster/images/clients/logo-1.jpg" alt="">
                            </div>
